...
public final class GL_Util {
    ...
    public static void showMatrix44 (float m []) { showMatrix (m, 16); }
    public static void showMatrix41 (float m []) { showMatrix (m, 4); }
    ...
    public static float det33 (float a1, float a2, float a3,
    ...
    public static float det44 (float a1, float a2, float a3, float a4,
	...
	float m [] = adjoint44 (a);
	float det = det44 (m [ 0], m [ 1], m [ 2], m [ 3],
			   m [ 4], m [ 5], m [ 6], m [ 7],
			   m [ 8], m [ 9], m [10], m [11],
			   m [12], m [13], m [14], m [15]);
	int i;
    ...
    public static float normalize (float p []) {
        ...
        if (w > 0.000001f) { p[0]/=w; p[1]/=w; p[2]/=w; }
        return w;
    }
    ...
    public static int ItoA (int x) { return (((x & 0xff000000) >> 24) & 0x000000ff); }

...
public class GL_Image {
    ...
    private byte get_data (int x, int i, int s, Object data) {
    	if (s ==  8) return get_data (x, i, (byte [][])data);
    	if (s == 16) return get_data (x, i, (short[][])data);
    	if (s == 32) return get_data (x, i, (int  [][])data);
    ...
    private byte get_data (int x, int y, int i, int s, Object data) {
    	if (s ==  8) return get_data (x, y, i, (byte [][][])data);
    	if (s == 16) return get_data (x, y, i, (short[][][])data);
    	if (s == 32) return get_data (x, y, i, (int  [][][])data);
    	if (s == 64) return get_data (x, y, i, (float[][][])data);
    	return 0;
    }
    ...
    private byte get_data (int x, int y, int z, int i, int s, Object data) {
    	if (s ==  8) return get_data (x, y, z, i, (byte [][][][])data);
    	if (s == 16) return get_data (x, y, z, i, (short[][][][])data);
    	if (s == 32) return get_data (x, y, z, i, (int  [][][][])data);
    	if (s == 64) return get_data (x, y, z, i, (float[][][][])data);
    	return 0;
    }
...
*/
	...
	if (s ==  8) get_image (f, ((byte [][])pixels)[x], ImageData[x][0][0]);
	if (s == 16) get_image (f, ((short[][])pixels)[x], ImageData[x][0][0]);
	if (s == 32) get_image (f, ((int  [][])pixels)[x], ImageData[x][0][0]);
	if (s == 64) get_image (f, ((float[][])pixels)[x], ImageData[x][0][0]);
    }

    private void get_image (int x, int y, Object pixels, int f, int s) {
	if (s ==  8) get_image (f, ((byte [][][])pixels)[x][y], ImageData[x][y][0]);
	if (s == 16) get_image (f, ((short[][][])pixels)[x][y], ImageData[x][y][0]);
	if (s == 32) get_image (f, ((int  [][][])pixels)[x][y], ImageData[x][y][0]);
	if (s == 64) get_image (f, ((float[][][])pixels)[x][y], ImageData[x][y][0]);
    }

    private void get_image (int x, int y, int z, Object pixels, int f, int s) {
	if (s ==  8) get_image (f, ((byte [][][][])pixels)[x][y][z], ImageData[x][y][z]);
	if (s == 16) get_image (f, ((short[][][][])pixels)[x][y][z], ImageData[x][y][z]);
	if (s == 32) get_image (f, ((int  [][][][])pixels)[x][y][z], ImageData[x][y][z]);
	if (s == 64) get_image (f, ((float[][][][])pixels)[x][y][z], ImageData[x][y][z]);
    }
    ...
    public void set_sub_image (int x, int w, int f, int s,
...
*/
    ...
    public void set_sub_image (int x, int y, int w, int h, int f, int s,
			       GL_Pixel_Pack p, Object data) {
	int i, j, si, sj;
	byte r = (byte)0;
	byte g = (byte)0;
...
*/
    ...
    public GL_Image (int w, int c, int f, int s,
		     GL_Pixel_Pack p, Object data) {
	int i, si;
	byte r = (byte)0;
	byte g = (byte)0;
...
*/
    ...
    public GL_Image (int w, int h, int d, int c, int f, int s,
		     GL_Pixel_Pack p, Object data) {
	int i, j, k, si, sj, sk;
	byte r = (byte)0;
	byte g = (byte)0;

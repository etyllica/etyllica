...
public class GL_Material {
	...
	public void set_material (int pname, float params []) {
		...
		case GL.GL_EMISSION:  Emission  = params;    break;
		case GL.GL_SHININESS: Shininess = params[0]; break;
		case GL.GL_AMBIENT_AND_DIFFUSE:
			Ambient = params; Diffuse   = params;    break;
	...
	public float[] get_material (int pname) {
		...
		case GL.GL_EMISSION:  return Emission;

...
public class GL_Lit_Tex extends GL_Smooth {
	...
	protected void inc_x () { super.inc_x (); tex_inc_x(); }
	protected void dec_x () { super.dec_x (); tex_dec_x(); }
	protected void inc_y () { super.inc_y (); tex_inc_y(); }

	protected void inc_x_inc_y () { super.inc_x_inc_y(); tex_inc_x(); }
	protected void dec_x_inc_y () { super.dec_x_inc_y(); tex_dec_x(); }

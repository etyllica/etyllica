...
If you don't need 3D Graphics, Sound nor Physics, you just have to include to your project the lib [etyllica-2.3.jar](https://github.com/yuripourre/etyllica/blob/master/libs/etyllica-2.3.jar) (160Kb)

...
If you don't need 3D Graphics, Sound nor Physics, you just have to include the [etyllica-4.1.jar](https://github.com/yuripourre/etyllica/blob/master/Etyllica/libs/etyllica-4.1.jar) (220Kb)

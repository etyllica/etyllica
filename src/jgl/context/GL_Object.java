...
public abstract class GL_Object {
    ...
    public abstract void gl_read_index_pixels (int x, int y,
				     int width, int height,
				     int size, Object pixels);
    public abstract void gl_read_color_pixels (int x, int y,
				     int width, int height,
				     int format, int size, Object pixels);
    public abstract void gl_read_stencil_pixels (int x, int y,
				     int width, int height,
				     int size, Object pixels);
    public abstract void gl_read_depth_pixels (int x, int y,
				     int width, int height,
				     int size, Object pixels);
    public abstract void gl_draw_index_pixels (int width, int height,
				     int size, Object pixels);
    public abstract void gl_draw_color_pixels (int width, int height,
				     int format, int size, Object pixels);
    public abstract void gl_draw_stencil_pixels (int width, int height,
				     int size, Object pixels);
    public abstract void gl_draw_depth_pixels (int width, int height,
				     int size, Object pixels);
    ...
    public abstract void gl_tex_image_1d (int target, int level, int components,
                                     int width, int border,
				     int format, int size, Object pixels);
    public abstract void gl_tex_image_2d (int target, int level, int components,
                                     int width, int height, int border,
				     int format, int size, Object pixels);
    public abstract void gl_tex_image_3d (int target, int level, int components,
                                     int width, int height, int depth, int border,
				     int format, int size, Object pixels);
    public abstract void gl_bind_texture (int target, int texture);
    public abstract void gl_tex_sub_image_1d (int target, int level,
				     int xoffset,
				     int width,
				     int format, int size, Object pixels);
    public abstract void gl_tex_sub_image_2d (int target, int level,
				     int xoffset, int yoffset,
				     int width, int height,
				     int format, int size, Object pixels);
    public abstract void gl_tex_sub_image_3d (int target, int level,
				     int xoffset, int yoffset, int zoffset,
				     int width, int height, int depth,
				     int format, int size, Object pixels);
/*
    public abstract void gl_copy_tex_image_1d (int target, int level, int internalformat,
				     int x, int y,
				     int width,
				     int border);
    public abstract void gl_copy_tex_image_2d (int target, int level, int internalformat,
				     int x, int y,
				     int width, int height,
				     int border);
    public abstract void gl_copy_tex_sub_image_1d (int target, int level,
				     int xoffset, int yoffset,
				     int x, int y,
				     int width);
    public abstract void gl_copy_tex_sub_image_2d (int target, int level,
				     int xoffset, int yoffset,
				     int x, int y,
				     int width, int height);
    public abstract void gl_copy_tex_sub_image_3d (int target, int level,
				     int xoffset, int yoffset, int zoffset,
				     int x, int y,
				     int width, int height);
*/

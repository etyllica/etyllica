...
public class ColorHelper {
    ...
    public static Color darker(br.com.etyllica.commons.graphics.Color color, int intensity) {
        int a = color.getAlpha();
        int r = darker(color.getRed(), intensity);
        int g = darker(color.getGreen(), intensity);
        int b = darker(color.getBlue(), intensity);
    ...
    public static Color brighter(br.com.etyllica.commons.graphics.Color color, int intensity) {
        int a = color.getAlpha();
        int r = brighter(color.getRed(), intensity);
        int g = brighter(color.getGreen(), intensity);
        int b = brighter(color.getBlue(), intensity);
    ...
    public static Color convert(br.com.etyllica.commons.graphics.Color color) {

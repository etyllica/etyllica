...
public class GifDecoder {
	...
	protected List<ImageFrame> frames; // frames read from current file
	...
	protected void readImage() {
		...
		frames.add(new ImageFrame(image, delay)); // add image to frame list

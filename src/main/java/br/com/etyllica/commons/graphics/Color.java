...
public class Color {
    ...
    public static final Color SAVAGE_BLUE = new Color(0x00, 0x40, 0x80);
    ...
    public static final Color MOSS_GREEN = new Color(0x80, 0x80, 0x40);
    ...
    public static final Color DEEP_PINK = new Color(0xFF, 0x14, 0x93);
    public static final Color HOT_PINK = new Color(0xFF, 0x69, 0xB4);
    ...
    public static final Color LILAC = new Color(0x80, 0x00, 0xFF);
    public static final Color LAVENDAR = new Color(0x80, 0x80, 0xFF);
    public static final Color ORCHID = new Color(0xDA, 0x70, 0xD6);
    public static final Color DARK_ROSE = new Color(0xFF, 0x00, 0x80);
    ...
    public static final Color EGG_CUSTARD = new Color(0xFF, 0xFF, 0x80);
    ...
    public static final Color WOOD_BROWN = new Color(0x80, 0x40, 0x00);
    ...
    public static final Color RICH_BLACK = new Color(0x00, 0x40, 0x40);
    ...
    public static final Color SADDLE_BROWN = new Color(0x8B, 0x45, 0x13);
    ...
    public static final Color MINT_CREAM = new Color(0xF5, 0xFF, 0xFA);
    ...
    public static final Color SEA_SHELL = new Color(0xFF, 0xF5, 0xEE);

...
package org.jgl.context.attrib.lighting;
...
public class GL_Light {
	...
	public void set_light (int pname, float params []) {
		switch (pname) {
		case GL_AMBIENT:  Ambient  = params; break;
		case GL_DIFFUSE:  Diffuse  = params; break;
		case GL_SPECULAR: Specular = params; break;
		case GL_POSITION: Position = params;
		System.arraycopy (Position, 0, NormPosition, 0, 3);
		GL_Util.normalize (NormPosition);   break;
		case GL_SPOT_DIRECTION: SpotDirection = params;    break;
		case GL_SPOT_EXPONENT:  SpotExponent  = params[0]; break;
		case GL_SPOT_CUTOFF:    SpotCutoff    = params[0]; break;
	...
	public float[] get_light (int pname) {
		...
		case GL_DIFFUSE:        return Diffuse;
		case GL_SPECULAR:       return Specular;
		case GL_POSITION:       return Position;
		case GL_SPOT_DIRECTION: return SpotDirection;
		case GL_SPOT_EXPONENT:         temp[0]=SpotExponent;         break;
		case GL_SPOT_CUTOFF:           temp[0]=SpotCutoff;           break;
		case GL_CONSTANT_ATTENUATION:  temp[0]=ConstantAttenuation;  break;
		case GL_LINEAR_ATTENUATION:    temp[0]=LinearAttenuation;    break;
		case GL_QUADRATIC_ATTENUATION: temp[0]=QuadraticAttenuation; break;
		default: return null;
		}
		return temp;
	}

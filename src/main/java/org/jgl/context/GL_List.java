...
/*
    private static final int NODE_EVAL_COORD_1		= 33;
    private static final int NODE_EVAL_COORD_2		= 34;
    private static final int NODE_EVAL_MESH_1		= 35;
    private static final int NODE_EVAL_MESH_2		= 36;
...
/*
    ...
    private static final int NODE_MAP_GRID_1		= 55;
    private static final int NODE_MAP_GRID_2		= 56;
*/
...
//    private static final int NODE_TEX_ENV		= 86;
	...
	for (i = 0; i < ThisList.size (); i++) {
		...
		case NODE_COLOR_MASK:
		    CC.gl_color_mask (ListItem.BoolPtr[0],
				      ListItem.BoolPtr[1],
				      ListItem.BoolPtr[2],
				      ListItem.BoolPtr[3]);
		    break;
		case NODE_BLEND_FUNC:
		    CC.gl_blend_func (ListItem.IntPtr[0],
				      ListItem.IntPtr[1]);
		    break;
		case NODE_CULL_FACE:
		...
		case NODE_LINE_STIPPLE:
		    CC.gl_line_stipple (ListItem.IntPtr[0],
				 (short)ListItem.IntPtr[1]);
		    break;
		case NODE_POLYGON_MODE:
		    CC.gl_polygon_mode (ListItem.IntPtr[0],
					ListItem.IntPtr[1]);
		    break;
		...
		case NODE_DEPTH_RANGE:
		    CC.gl_depth_range (ListItem.FloatPtr[0],
				       ListItem.FloatPtr[1]);
		    break;
		...
		case NODE_MULT_MATRIX:
		    ...
		    break;
		case NODE_VIEWPORT:
		    CC.gl_viewport (ListItem.IntPtr[0],
				    ListItem.IntPtr[1],
				    ListItem.IntPtr[2],
				    ListItem.IntPtr [3]);
		    break;
		...
		case NODE_END:
		    ...
		    break;
		case NODE_VERTEX:
		    CC.gl_vertex (ListItem.FloatPtr[0],
				  ListItem.FloatPtr[1],
				  ListItem.FloatPtr[2],
				  ListItem.FloatPtr[3]);
		    break;
		case NODE_NORMAL:
		    CC.gl_normal (ListItem.FloatPtr[0],
				  ListItem.FloatPtr[1],
				  ListItem.FloatPtr[2]);
		    break;
		case NODE_INDEX:
		    ...
		    break;
		case NODE_COLOR:
		    CC.gl_color (ListItem.FloatPtr[0],
				 ListItem.FloatPtr[1],
				 ListItem.FloatPtr[2],
				 ListItem.FloatPtr[3]);
		    break;
		case NODE_TEX_COORD:
		    CC.gl_tex_coord (ListItem.FloatPtr[0],
				     ListItem.FloatPtr[1],
				     ListItem.FloatPtr[2],
				     ListItem.FloatPtr[3]);
		    break;
/*
		case NODE_MAP_1:
		    CC.gl_map_1 (ListItem.IntPtr[0], ListItem.FloatPtr[0],
						     ListItem.FloatPtr[1],
				 ListItem.IntPtr[1], ListItem.IntPtr[2],
		      (float[][])ListItem.ObjPtr);
		    break;
		case NODE_MAP_2:
		    CC.gl_map_2 (ListItem.IntPtr[0],
				 ListItem.FloatPtr[0], ListItem.FloatPtr[1],
				 ListItem.IntPtr[1],   ListItem.IntPtr[2],
				 ListItem.FloatPtr[2], ListItem.FloatPtr[3],
				 ListItem.IntPtr[3],   ListItem.IntPtr[4],
		    (float[][][])ListItem.ObjPtr);
		    break;
		case NODE_EVAL_COORD_1:
		    CC.gl_eval_coord_1 (ListItem.FloatPtr[0]);
		    break;
		case NODE_EVAL_COORD_2:
		    CC.gl_eval_coord_2 (ListItem.FloatPtr[0],
					ListItem.FloatPtr[1]);
		    break;
		case NODE_MAP_GRID_1:
		    CC.gl_map_grid_1 (ListItem.IntPtr[0],
				      ListItem.FloatPtr[0],
				      ListItem.FloatPtr[1]);
		    break;
		case NODE_MAP_GRID_2:
		    CC.gl_map_grid_2 (ListItem.IntPtr[0],
				      ListItem.FloatPtr[0],
				      ListItem.FloatPtr[1],
				      ListItem.IntPtr[1],
				      ListItem.FloatPtr[2],
				      ListItem.FloatPtr[3]);
		    break;
		case NODE_EVAL_POINT_1:
		    CC.gl_eval_point_1 (ListItem.IntPtr[0]);
		    break;
		case NODE_EVAL_POINT_2:
		    CC.gl_eval_point_2 (ListItem.IntPtr[0],
					ListItem.IntPtr[1]);
		    break;
		case NODE_EVAL_MESH_1:
		    CC.gl_eval_mesh_1 (ListItem.IntPtr[0],
				       ListItem.IntPtr[1],
				       ListItem.IntPtr[2]);
		    break;
		case NODE_EVAL_MESH_2:
		    CC.gl_eval_mesh_2 (ListItem.IntPtr[0],
				       ListItem.IntPtr[1],
				       ListItem.IntPtr[2],
				       ListItem.IntPtr[3],
				       ListItem.IntPtr[4]);
...
*/
		case NODE_RASTER_POS:
		    CC.gl_raster_pos (ListItem.FloatPtr[0],
				      ListItem.FloatPtr[1],
				      ListItem.FloatPtr[2],
				      ListItem.FloatPtr[3]);
		    break;
		case NODE_SHADE_MODEL:
		    ...
		    break;
		case NODE_LIGHT:
		    CC.gl_light (ListItem.IntPtr[0],
				 ListItem.IntPtr[1], ListItem.FloatPtr);
		    break;
		case NODE_LIGHT_MODEL:
		    CC.gl_light_model (ListItem.IntPtr[0], ListItem.FloatPtr);
		    break;
		case NODE_MATERIAL:
		    CC.gl_material (ListItem.IntPtr[0],
				    ListItem.IntPtr[1], ListItem.FloatPtr);
		    break;
		case NODE_COLOR_MATERIAL:
		    CC.gl_color_material (ListItem.IntPtr[0],
					  ListItem.IntPtr[1]);
		    break;
		case NODE_DRAW_INDEX_PIXELS:
		    CC.gl_draw_index_pixels (ListItem.IntPtr[0],
					     ListItem.IntPtr[1],
					     ListItem.IntPtr[2],
					     ListItem.ObjPtr);
		    break;
		case NODE_DRAW_COLOR_PIXELS:
		    CC.gl_draw_color_pixels (ListItem.IntPtr[0],
					     ListItem.IntPtr[1],
					     ListItem.IntPtr[2],
					     ListItem.IntPtr[3],
					     ListItem.ObjPtr);
		...
		case NODE_DRAW_STENCIL_PIXELS:
		    CC.gl_draw_stencil_pixels (ListItem.IntPtr[0],
					       ListItem.IntPtr[1],
					       ListItem.IntPtr[2],
					       ListItem.ObjPtr);
		    break;
		case NODE_DRAW_DEPTH_PIXELS:
		    CC.gl_draw_depth_pixels (ListItem.IntPtr[0],
					     ListItem.IntPtr[1],
					     ListItem.IntPtr[2],
					     ListItem.ObjPtr);
		    break;
		case NODE_COPY_COLOR_PIXELS:
		    CC.gl_copy_color_pixels (ListItem.IntPtr[0],
					     ListItem.IntPtr[1],
					     ListItem.IntPtr[2],
					     ListItem.IntPtr[3]);
		    break;
		case NODE_COPY_STENCIL_PIXELS:
		    CC.gl_copy_stencil_pixels (ListItem.IntPtr[0],
					       ListItem.IntPtr[1],
					       ListItem.IntPtr[2],
					       ListItem.IntPtr[3]);
		    break;
		case NODE_COPY_DEPTH_PIXELS:
		    CC.gl_copy_depth_pixels (ListItem.IntPtr[0],
					     ListItem.IntPtr[1],
					     ListItem.IntPtr[2],
					     ListItem.IntPtr[3]);
		    break;
		case NODE_STENCIL_FUNC:
		    CC.gl_stencil_func (ListItem.IntPtr[0],
					ListItem.IntPtr[1],
					ListItem.IntPtr[2]);
		    break;
		...
		case NODE_STENCIL_OP:
		    CC.gl_stencil_op (ListItem.IntPtr[0],
				      ListItem.IntPtr[1],
				      ListItem.IntPtr[2]);
		    break;
		case NODE_CLEAR_STENCIL:
		    ...
		    break;
		case NODE_TEX_GEN_I:
		    CC.gl_tex_gen_i (ListItem.IntPtr[0],
				     ListItem.IntPtr[1]);
		    break;
		case NODE_TEX_GEN_F:
		    CC.gl_tex_gen_f (ListItem.IntPtr[0],
				     ListItem.IntPtr[1],
				     ListItem.FloatPtr);
		    break;
		case NODE_TEX_ENV_I:
		...
		case NODE_TEX_PARAMETER:
		    CC.gl_tex_parameter (ListItem.IntPtr[0],
					 ListItem.IntPtr[1],
				(float[])ListItem.ObjPtr);
		    break;
		case NODE_TEX_IMAGE_1D:
		    CC.gl_tex_image_1d (ListItem.IntPtr[0],
					ListItem.IntPtr[1],
					ListItem.IntPtr[2],
					ListItem.IntPtr[3],
					ListItem.IntPtr[4],
		...
		case NODE_TEX_IMAGE_2D:
		    CC.gl_tex_image_2d (ListItem.IntPtr[0],
					ListItem.IntPtr[1],
					ListItem.IntPtr[2],
					ListItem.IntPtr[3],
					ListItem.IntPtr[4],
		...
		case NODE_TEX_IMAGE_3D:
		    CC.gl_tex_image_3d (ListItem.IntPtr[0],
					ListItem.IntPtr[1],
					ListItem.IntPtr[2],
					ListItem.IntPtr[3],
					ListItem.IntPtr[4],
		...
		case NODE_BIND_TEXTURE:
		    CC.gl_bind_texture (ListItem.IntPtr[0],
					ListItem.IntPtr[1]);
		    break;
		case NODE_TEX_SUB_IMAGE_1D:
		    CC.gl_tex_sub_image_1d (ListItem.IntPtr[0],
					    ListItem.IntPtr[1],
					    ListItem.IntPtr[2],
					    ListItem.IntPtr[3],
					    ListItem.IntPtr[4],
		...
		case NODE_TEX_SUB_IMAGE_2D:
		    CC.gl_tex_sub_image_2d (ListItem.IntPtr[0],
					    ListItem.IntPtr[1],
					    ListItem.IntPtr[2],
					    ListItem.IntPtr[3],
					    ListItem.IntPtr[4],
		...
		case NODE_TEX_SUB_IMAGE_3D:
		    CC.gl_tex_sub_image_3d (ListItem.IntPtr[0],
					    ListItem.IntPtr[1],
					    ListItem.IntPtr[2],
					    ListItem.IntPtr[3],
					    ListItem.IntPtr[4],
    ...
    public void gl_clear_color (float red, float green,
    ...
    public void gl_clear_depth_buffer () {
    	...
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_clear_depth_buffer (); }
    }
	...
	ListItem.IntPtr [0] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_cull_face (mode); }
    }
	...
	ListItem.IntPtr [0] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_front_face (mode); }
    }
	...
	ListItem.FloatPtr [0] = size;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_point_size (size); }
    }
	...
	ListItem.FloatPtr [0] = width;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_line_width (width); }
    }
	...
	ListItem.IntPtr [1] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_polygon_mode (face, mode); }
    }
	...
	ListItem.FloatPtr = equation;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_clip_plane (plane, equation); }
    }
	...
	ListItem.BoolPtr [0] = state;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_enable (cap, state); }
    }
	...
	ListItem.FloatPtr [0] = depth;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_clear_depth (depth); }
    }
	...
	ListItem.BoolPtr [0] = flag;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_depth_mask (flag); }
    }
	...
	ListItem.FloatPtr [1] = f;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_depth_range (n, f); }
    }
	...
	ListItem.IntPtr [0] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_matrix_mode (mode); }
    }
	...
	ListItem.FloatPtr = m;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_mult_matrix (m); }
    }
	...
	ListItem.FloatPtr = IDENTITY;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_load_identity_matrix (); }
    }
	...
	ListItem.FloatPtr = m;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_load_matrix (m); }
    }
	...
	ListItem.FloatPtr = a;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_mult_matrix (a); }
    }
	...
	ListItem.IntPtr [0] = list;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_call_list (list); }
    }
	...
	ListItem.IntPtr [0] = offset;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_call_offset (offset); }
    }
	...
	ListItem.IntPtr [0] = base;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_list_base (base); }
    }
	...
	ListItem.IntPtr [0] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_begin (mode); }
    }
	...
	ListItem.FloatPtr [3] = w;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_vertex (x, y, z, w); }
    }
	...
	ListItem.IntPtr [0] = c;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_index (c); }
    }
	...
	ListItem.IntPtr [0] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_shade_model (mode); }
    }
	...
	ListItem.FloatPtr = params;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_light (light, pname, params); }
    }
	...
	ListItem.FloatPtr = params;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_light_model (pname, params); }
    }
	...
	ListItem.FloatPtr = params;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_material (face, pname, params); }
    }
	...
	ListItem.IntPtr [1] = mode;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_color_material (face, mode); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_draw_index_pixels (width, height,
							 size, pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_draw_color_pixels (width, height,
							 format, size,
							 pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_draw_stencil_pixels (width, height,
							   size, pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_draw_depth_pixels (width, height,
							 size, pixels); }
    }
	...
	ListItem.IntPtr [3] = height;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_copy_color_pixels (x, y, width, height); }
    }
	...
	ListItem.IntPtr [3] = height;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_copy_stencil_pixels (x, y, width, height); }
    }
	...
	ListItem.IntPtr [3] = height;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_copy_depth_pixels (x, y, width, height); }
    }
	...
	ListItem.IntPtr [2] = mask;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_stencil_func (func, ref, mask); }
    }
	...
	ListItem.IntPtr [0] = mask;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_stencil_mask (mask); }
    }
	...
	ListItem.IntPtr [2] = zpass;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_stencil_op (fail, zfail, zpass); }
    }
	...
	ListItem.IntPtr [0] = s;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_clear_stencil (s); }
    }
	...
	ListItem.IntPtr [1] = param;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_gen_i (coord, param); }
    }
	...
	ListItem.FloatPtr = params;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_gen_f (coord, pname, params); }
    }
	...
	ListItem.IntPtr [0] = param;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_env_i (param); }
    }
	...
	ListItem.FloatPtr = params;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_env_f (params); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_image_1d (target, level, components,
						    width, border,
						    format, size, pixels); }
    }
...
//				 int format, int type, byte pixels [][][]) {
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_image_2d (target, level, components,
						    width, height, border,
						    format, size, pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_image_3d (target, level, components,
	...
	ListItem.IntPtr [1] = texture;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_bind_texture (target, texture); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_sub_image_1d (target, level,
							xoffset,
							width,
							format, size, pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_sub_image_2d (target, level,
							xoffset, yoffset,
							width, height,
							format, size, pixels); }
    }
	...
	ListItem.ObjPtr = pixels;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_tex_sub_image_3d (target, level,
 ...
 /*   
	...
	ListItem.IntPtr = new int [3];
	ListItem.IntPtr [0] = target;
	ListItem.IntPtr [1] = stride;
	ListItem.IntPtr [2] = order;
	ListItem.FloatPtr = new float [2];
	ListItem.FloatPtr [0] = u1;
	ListItem.FloatPtr [1] = u2;

	int i, j, dim;
	switch (target) {
	    case GL.GL_MAP1_VERTEX_3:        dim = 3; break;
	    case GL.GL_MAP1_VERTEX_4:        dim = 4; break;
	    case GL.GL_MAP1_INDEX:           dim = 1; break;
	    case GL.GL_MAP1_COLOR_4:         dim = 4; break;
	    case GL.GL_MAP1_NORMAL:          dim = 3; break;
	    case GL.GL_MAP1_TEXTURE_COORD_1: dim = 1; break;
	    case GL.GL_MAP1_TEXTURE_COORD_2: dim = 2; break;
	    case GL.GL_MAP1_TEXTURE_COORD_3: dim = 3; break;
	    case GL.GL_MAP1_TEXTURE_COORD_4: dim = 4; break;
	    default:                         dim = 0;
	}

	float temp [][] = new float [order][dim];
	for (i = 0; i < order; i++)
	    for (j = 0; j < dim; j++)
		temp[i][j] = points[i][j];

	ListItem.ObjPtr = (Object)temp;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_map_1 (target, u1, u2, stride, order,
    					     points); }
    	return dim;
    }
    ...
    public int gl_map_2 (int target, float u1, float u2, int ustride, int uorder,
			 ...
			 float points [][][]) {
	ListItem = new gl_list_item (NODE_MAP_2);
	ListItem.IntPtr = new int [5];
	ListItem.IntPtr [0] = target;
	ListItem.IntPtr [1] = ustride;
	ListItem.IntPtr [2] = uorder;
	ListItem.IntPtr [3] = vstride;
	ListItem.IntPtr [4] = vorder;
	ListItem.FloatPtr = new float [4];
	ListItem.FloatPtr [0] = u1;
	ListItem.FloatPtr [1] = u2;
	ListItem.FloatPtr [2] = v1;
	ListItem.FloatPtr [3] = v2;

	int i, j, k, dim;
	switch (target) {
	    case GL.GL_MAP2_VERTEX_3:        dim = 3; break;
	    case GL.GL_MAP2_VERTEX_4:        dim = 4; break;
	    case GL.GL_MAP2_INDEX:           dim = 1; break;
	    case GL.GL_MAP2_COLOR_4:         dim = 4; break;
	    case GL.GL_MAP2_NORMAL:          dim = 3; break;
	    case GL.GL_MAP2_TEXTURE_COORD_1: dim = 1; break;
	    case GL.GL_MAP2_TEXTURE_COORD_2: dim = 2; break;
	    case GL.GL_MAP2_TEXTURE_COORD_3: dim = 3; break;
	    case GL.GL_MAP2_TEXTURE_COORD_4: dim = 4; break;
	    default:                         dim = 0;
	}

	float temp [][][] = new float [uorder][vorder][dim];
	for (i = 0; i < uorder; i++)
	    for (j = 0; j < vorder; j++)
		for (k = 0; k < dim; k++)
		    temp[i][j][k] = points[i][j][k];

	ListItem.ObjPtr = (Object)temp;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_map_2 (target, u1, u2, ustride, uorder,
	...
	ListItem.FloatPtr = new float [1];
	ListItem.FloatPtr [0] = u;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_coord_1 (u); }
    }

    public void gl_eval_coord_2 (float u, float v) {
	ListItem = new gl_list_item (NODE_EVAL_COORD_2);
	ListItem.FloatPtr = new float [2];
	ListItem.FloatPtr [0] = u;
	ListItem.FloatPtr [1] = v;
	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_coord_2 (u, v); }
    }

    public void gl_map_grid_1 (int un, float u1, float u2) {
	ListItem = new gl_list_item (NODE_MAP_GRID_1);
	ListItem.IntPtr = new int [1];
	ListItem.IntPtr [0] = un;
	ListItem.FloatPtr = new float [2];
	ListItem.FloatPtr [0] = u1;
	ListItem.FloatPtr [1] = u2;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_map_grid_1 (un, u1, u2); }
    }

    public void gl_map_grid_2 (int un, float u1, float u2,
			       int vn, float v1, float v2) {
	ListItem = new gl_list_item (NODE_MAP_GRID_2);
	ListItem.IntPtr = new int [2];
	ListItem.IntPtr [0] = un;
	ListItem.IntPtr [1] = vn;
	ListItem.FloatPtr = new float [4];
	ListItem.FloatPtr [0] = u1;
	ListItem.FloatPtr [1] = u2;
    	ListItem.FloatPtr [2] = v1;
	...
	ListItem.IntPtr [0] = i;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_point_1 (i); }
    }

    public void gl_eval_point_2 (int i, int j) {
	ListItem = new gl_list_item (NODE_EVAL_POINT_2);
	ListItem.IntPtr = new int [2];
	ListItem.IntPtr [0] = i;
	ListItem.IntPtr [1] = j;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_point_2 (i, j); }
    }

    public void gl_eval_mesh_1 (int mode, int nu1, int nu2) {
	ListItem = new gl_list_item (NODE_EVAL_MESH_1);
	ListItem.IntPtr = new int [3];
	ListItem.IntPtr [0] = mode;
	ListItem.IntPtr [1] = nu1;
	ListItem.IntPtr [2] = nu2;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_mesh_1 (mode, nu1, nu2); }
    }

    public void gl_eval_mesh_2 (int mode, int nu1, int nu2,
    					  int nv1, int nv2) {
	ListItem = new gl_list_item (NODE_EVAL_MESH_2);
	ListItem.IntPtr = new int [5];
	ListItem.IntPtr [0] = mode;
	ListItem.IntPtr [1] = nu1;
	ListItem.IntPtr [2] = nu2;
    	ListItem.IntPtr [3] = nv1;
	ListItem.IntPtr [4] = nv2;
    	ThisList.addElement (ListItem);
    	if (ExecuteFlag) { Context.gl_eval_mesh_2 (mode, nu1, nu2, nv1, nv2); }
    }
*/
	...
	ListItem.FloatPtr [0] = token;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_pass_through (token); }
    }
    ...
    public void gl_init_names () {
    	...
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_init_names (); }
    }
	...
	ListItem.IntPtr [0] = name;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_load_name (name); }
    }
	...
	ListItem.IntPtr [0] = name;
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_push_name (name); }
    }

    public void gl_pop_name () {
    	ListItem = new GL_List_Item (NODE_POP_NAME);
    	ThisList.addElement (ListItem);
	if (ExecuteFlag) { Context.gl_pop_name (); }
    }

...
/**
 * gl_lit_tex_z is the rendering class for texturing with lighting and depth
 * of jGL 2.3.
 *
...
public class GL_Lit_Tex_Z extends GL_Lit_Tex {
    ...
    private void draw_horizontal_line (int   x1, int rgb1 [],
	...
	draw_horizontal_line (LeftPoint, LeftPointRGB,
			      RightPoint, RightPointRGB, y, LeftPointZ,

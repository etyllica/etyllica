...
public class Matrix4 implements Serializable {
	...
	public static boolean matrix4_inv(float[] val) {
		float[] tmp = new float[16];
	...
	public static void matrix4_mulVec(float[] mat, float[] vec) {
	...
	public static void matrix4_proj(float[] mat, float[] vec) {
	...
	public static void matrix4_rot(float[] mat, float[] vec) {
